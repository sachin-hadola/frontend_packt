        ...
        <div class="card border-0 shadow rounded-3 my-3">
            <div class="card-body p-4 p-sm-5">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 mt-2">
                        <div class="mb-3">
                            <button class="btn btn-primary btn-lg mt-1 ml-2" @click="applyFilter()">Submit</button>&nbsp;
            ...
            <div class="card-body p-4 p-sm-5">
                <div class="row">
                    <div class="col-md-12 mt-2">
                        <h5 class="card-title mb-2 fw-light fs-5" style="float: left;">Book List</h5>
                        <router-link class="btn btn-primary" :to="{ name: 'admin.books.create' }" style="float: right;">Add New
                            </router-link>
                    </div>
                </div>
                <div class="row">
